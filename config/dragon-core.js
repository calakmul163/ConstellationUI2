    ...
    Alpine.data('app', () => ({
        ...
        styles: {
            ...
            microsites: {
                ...
                a_b_fuchsia_border: 'flex items-center justify-between w-auto py-2 px-2 mx-auto mb-4 border-3 rounded-full backdrop-blur-sm bg-white/30 border-fuchsia-600 md:ml-0 group hover:bg-purple-200/70 hover:border-purple-700 group group-hover:!-translate-x-0.5 transition-all duration-700 ease-in-out',
                a_b_span_fuchsia_border: 'ml-3 mr-3 !text-xs !font-medium !text-slate-900 group-hover:!text-purple-900 group-hover:!-translate-x-0.5 transition-all duration-700 ease-in-out',
